package com.example.apphappy.fragment;
...
import com.example.apphappy.PokeapiService.PokeapiService;
import com.example.apphappy.R;
import com.example.apphappy.adapters.ListaPokemonAdapter;
...
public class FiltersFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        listaPokemonAdapter=new ListaPokemonAdapter(getContext()); //para fragments es getContext si es activity es thisContex
        ...
        recyclerView.addOnScrollListener(new RecyclerView.OnScrollListener() {
            ...
            public void onScrolled(@NonNull RecyclerView recyclerView, int dx, int dy) {
                ...
                if (dy>0){
                    int visibleItemCount= layoutManager.getItemCount(); //en la guia puso getChildCount()
        ...
        //esta parte se cambio de lugar ya que antes estaba antes de "// Inflate the layout for this fragment"
